...
static void service_changed_cb(__attribute__((unused)) uint16_t value_handle, const uint8_t * value,
                               uint16_t length, void * user_data) {
    struct bt_gatt_client * client = user_data;
...
static void disable_ccc_callback(__attribute__((unused)) uint8_t opcode, __attribute__((unused)) const void * pdu,
                                 __attribute__((unused)) uint16_t length, __attribute__((unused)) void * user_data) {
    struct notify_data * notify_data = user_data;
...
static void att_disconnect_cb(__attribute__((unused)) int err, void * user_data) {
    struct bt_gatt_client * client = user_data;
...
static void cancel_long_write_cb(__attribute__((unused)) uint8_t opcode, __attribute__((unused)) const void * pdu, __attribute__((unused)) uint16_t len,
                                 void * user_data) {
    struct bt_gatt_client * client = user_data;
...
static void cancel_prep_write_cb(__attribute__((unused)) uint8_t opcode, __attribute__((unused)) const void * pdu, __attribute__((unused)) uint16_t len,
                                 void * user_data) {
...
static void cancel_request_wrapper(void * req) {
    cancel_request(req);
}
...
bool bt_gatt_client_cancel_all(struct bt_gatt_client * client) {
    ...
    queue_remove_all(client->pending_requests, NULL, NULL,
                     (queue_destroy_func_t) cancel_request_wrapper);
